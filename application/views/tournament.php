        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    Tournament <?= $this->session->flashdata('flash'); ?>.
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        onclick="passUpdateData(<?=$data['id_tour']?>, '<?=$data['nama']?>', '<?=$data['deskripsi']?>', 
                        '<?=$data['tempat']?>', '<?=$data['tanggal']?>', '<?=$data['jenis_games']?>')"
                        data-bs-nama="<?= $data['nama']?>" data-bs-toggle="modal" data-bs-target="#updateModal">Update</a>
                        <a class="btn btn-danger" href="<?= base_url(); ?>controller_tournament/hapusTournament/<?=$data['id_tour']?>"class="badge badge-danger  float-center p-3" onclick="return confirm('Apakah anda yakin menghapus data ini?');" ?>Delete</a>
                    </td>
                </tr>
            </tbody>
            <?php
