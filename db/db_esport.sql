...
--
-- Host: 127.0.0.1
-- Generation Time: May 12, 2023 at 04:24 PM
...
INSERT INTO `tb_partisipasi_tournament` (`id`, `id_tour`, `nama_team`) VALUES
(247, 5, 'test'),
(248, 7, 'test1'),
(249, 7, 'test2'),
(250, 6, 'test'),
...
(1, '6AMilyar', 'tim 6AMi', 'PUBG'),
(2, 'test', 'tes', 'Dota 2'),
(3, 'proting', 'proting 3', 'Valorant');
...
INSERT INTO `tb_user` (`id`, `nama`, `username`, `password`, `role_id`, `nama_team`) VALUES
(1, 'admin', 'admin', 'admin123', 1, ''),
(2, 'user', 'user', 'user123', 2, 'test'),
(4, 'user', 'adit', 'adit3', 2, ''),
(5, 'ggrr', 'h', 'h', 2, ''),
(6, 'zarvah', 'zarvah', '123', 2, ''),
(7, '3', 'joko', '3', 2, '');
...
--
ALTER TABLE `tb_team`
  MODIFY `id_team` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tb_tournament`
--
ALTER TABLE `tb_tournament`
  MODIFY `id_tour` int(23) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
